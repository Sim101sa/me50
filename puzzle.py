...
# B says nothing.
knowledge1 = And(Or(AKnave,BKnave), 
...
knowledge2 = And( Or(And(AKnight,BKnave),And(AKnave,BKnight)), 
...
knowledge3 = And(Or(Implication(AKnight,AKnight),Implication(AKnight, AKnave)),  
